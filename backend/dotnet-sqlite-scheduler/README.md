...
# Bryntum Scheduler ASP.NET Core API

A basic ASP.NET Core API for performing CRUD operations on a local SQLite database. For use with a Bryntum Scheduler front end.
...
This will create a `scheduler.sqlite3` file in the project directory.
