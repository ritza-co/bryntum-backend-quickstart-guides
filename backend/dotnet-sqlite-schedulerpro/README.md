...
# Bryntum Scheduler Pro ASP.NET Core API

A basic ASP.NET Core API for performing CRUD operations on a local SQLite database. For use with a Bryntum Scheduler Pro front end.
...
This will create a `schedulerpro.sqlite3` file in the project directory.
