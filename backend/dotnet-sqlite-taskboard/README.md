...
# Bryntum Taskboard ASP.NET Core API

A basic ASP.NET Core API for performing CRUD operations on a local SQLite database. For use with a Bryntum Taskboard front end.
...
This will create a `taskboard.sqlite3` file in the project directory.
