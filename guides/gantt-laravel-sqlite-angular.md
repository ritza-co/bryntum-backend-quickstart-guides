# How to Create an Angular Bryntum Gantt with Laravel and SQLite

This guide shows how to create a complete CRUD gantt chart application using a TypeScript Angular Bryntum Gantt frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir gantt-laravel-sqlite-angular
cd gantt-laravel-sqlite-angular
mkdir backend
cd backend
...
<head>
  <meta charset="utf-8">
  <title>How to use an Angular Bryntum Gantt with a backend API</title>
  <base href="/">
