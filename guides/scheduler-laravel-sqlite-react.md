# How to create a React Bryntum Scheduler with Laravel and SQLite

This guide shows how to create a complete CRUD scheduler application using a TypeScript React Bryntum Scheduler frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir scheduler-laravel-sqlite-react
cd scheduler-laravel-sqlite-react
mkdir backend
cd backend
