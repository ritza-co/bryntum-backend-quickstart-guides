# How to create a Bryntum Gantt with Express and SQLite

This guide shows how to create a complete CRUD Gantt chart application using a TypeScript Bryntum Gantt frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
