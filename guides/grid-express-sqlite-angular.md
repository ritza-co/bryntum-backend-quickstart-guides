# How to create an Angular Bryntum Grid with Express and SQLite

This guide shows how to create a complete CRUD Grid application using a TypeScript Angular Bryntum Grid frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
