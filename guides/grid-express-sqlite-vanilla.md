# How to create a Bryntum Grid with Express and SQLite

This guide shows how to create a complete CRUD Grid application using a TypeScript Bryntum Grid frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
