# How to create a Bryntum Calendar with Express and SQLite

This guide shows how to create a complete CRUD Calendar application using a TypeScript Bryntum Calendar frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
