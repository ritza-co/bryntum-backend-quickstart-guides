# How to Create a Vue Bryntum Gantt with Laravel and SQLite

This guide shows how to create a complete CRUD gantt chart application using a TypeScript Vue Bryntum Gantt frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir gantt-laravel-sqlite-vue
cd gantt-laravel-sqlite-vue
mkdir backend
cd backend
...
<html lang="en">
  <head>
    ...
    <title>How to use a Vue Bryntum Gantt with a backend API</title>
  </head>
  <body>
    <div id="app"></div>
