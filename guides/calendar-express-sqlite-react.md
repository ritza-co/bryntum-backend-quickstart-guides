# How to create a Bryntum Calendar with Express, SQLite and React

This guide shows how to create a complete CRUD Calendar application using a React Bryntum Calendar frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
