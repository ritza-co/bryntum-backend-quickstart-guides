# How to Create a Bryntum Grid with Laravel and SQLite

This guide shows how to create a complete CRUD grid application using a TypeScript Bryntum Grid frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir grid-laravel-sqlite-vanilla
cd grid-laravel-sqlite-vanilla
mkdir backend
cd backend
...
<html lang="en">
  <head>
    ...
    <title>How to use a Vanilla Bryntum Grid with a backend API</title>
  </head>
  <body>
    <div id="app"></div>
