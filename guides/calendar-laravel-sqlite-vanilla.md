# How to Create a Vanilla JavaScript Bryntum Calendar with Laravel and SQLite

This guide shows how to create a complete CRUD Calendar application using a vanilla JavaScript Bryntum Calendar frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir calendar-laravel-sqlite-vanilla
cd calendar-laravel-sqlite-vanilla
mkdir backend
cd backend
...
<html lang="en">
  <head>
    ...
    <title>How to use a Vanilla JavaScript Bryntum Calendar with a backend API</title>
