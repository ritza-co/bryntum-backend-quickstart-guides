# How to create a Vue Bryntum Task Board with Express and SQLite

This guide shows how to create a complete CRUD Task Board application using a TypeScript Vue Bryntum Task Board frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
