# How to create a Bryntum Scheduler Pro with Express and SQLite

This guide shows how to create a complete CRUD Scheduler Pro application using a TypeScript Bryntum Scheduler Pro frontend and an Express backend with Sequelize ORM connected to a local SQLite database.
...
```bash
mkdir schedulerpro-express-sqlite-vanilla
cd schedulerpro-express-sqlite-vanilla
mkdir backend
cd backend
npm init -y
```
...
export { Assignment, Event, Resource, Dependency };
```
