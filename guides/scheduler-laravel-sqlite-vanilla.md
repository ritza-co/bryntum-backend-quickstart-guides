# How to create a Bryntum Scheduler with Laravel and SQLite

This guide shows how to create a complete CRUD Scheduler application using a TypeScript Bryntum Scheduler frontend and a Laravel backend using Eloquent ORM and a local SQLite database.
...
```bash
mkdir scheduler-laravel-sqlite-vanilla
cd scheduler-laravel-sqlite-vanilla
mkdir backend
cd backend
